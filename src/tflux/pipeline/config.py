...
sample_b_dir_path: Path = Path("data/raw/all-data/Bleb/Bleb100uM")   # experimental (compared with a), requires 'compare_samples_ab = True' to analyze
...
'''
summarize_junc = True       # Generate analysis plots for every junction found in sample, Figure 1c-1k. SLOW with lots of .objs.
save_cells = True           # Save a render of each cell in the sample. Figure 1b. SLOW with lots of .objs.
...
### Base Analysis of One Sample ###
analyze_sample_WT = False
...
LOW_FREQ_BIN_OMIT: int = 3      # Omit the N lowest positive-frequency bins (q and w) from log-log linear regression: finite-window/apodization leakage inflates the low-frequency bins.
